...
public class S3Uploader {
    ...
    private static final List<String> IMAGE_EXTENSIONS = Arrays.asList(".jpg", ".jpeg", ".gif", ".png", ".img", ".tiff", ".heif");
    private static final String TEMP_FILE_PATH = "pick-me-up-server/src/main/resources/";
